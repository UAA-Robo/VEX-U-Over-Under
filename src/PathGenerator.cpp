...
void PathGenerator::generate_path(
            ...
            while (curr_region != target_region) {
                ...
                path.push_back(map->get_critical_point(curr_region, true));
                path.push_back(map->get_critical_point(curr_region + direction, false));
                curr_region = map->in_which_region(
                    map->get_critical_point(curr_region + direction, false));
            }
